...
def create_data(args):
    ...
    with open("./data_processed/{}/seed-{}-ratio-{}/{}_raw.json".format(args["mwz_ver"], args["seed"], args["data_ratio"], args["stage"]), 'w', encoding="utf-8") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--remove_excluded_utterances", default=1, type=int)
