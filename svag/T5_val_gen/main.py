...
def train(args):
    ...
    checkpoint_callback = ModelCheckpoint(dirpath="./save/{}".format(args.name), save_top_k=1, monitor="turn_acc",
                                          mode="max")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dev_name", default='', type=str)
    ...
    parser.add_argument("--vci", default=1.0, type=float)
    parser.add_argument("--num_device", default=0, type=int)
    parser.add_argument("--level_1", default="", type=str)
    parser.add_argument("--level_2", default="", type=str)
    parser.add_argument("--augmented_data_dir", default='', type=str)
