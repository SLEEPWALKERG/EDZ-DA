...
class DSTDataset(pl.LightningDataModule):
    ...
    def setup(self, stage):
        if stage == "fit" or stage is None:
            with open("../data/T5_DST_data/data/{}/{}.json".format(self.args.mwz_ver, self.args.train_dir), encoding="utf-8") as f:
            ...
            with open("../data/T5_DST_data/data/{}/{}.json".format(self.args.mwz_ver, self.args.dev_name), encoding="utf-8") as f:
                self.dev = json.load(f)
        if stage == "test" or stage is None:
            with open("../data/T5_DST_data/data/{}/{}.json".format(self.args.mwz_ver, self.args.test_name), encoding="utf-8") as f:
